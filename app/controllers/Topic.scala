...
class Topic (val messagesApi: MessagesApi, val kafkaManagerContext: KafkaManagerContext)
  ...
  val kafka_0_8_1_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_8_1_1).map(n => TConfig(n,None)).toList)
  val kafka_0_8_2_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_8_2_0).map(n => TConfig(n,None)).toList)
  val kafka_0_8_2_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_8_2_1).map(n => TConfig(n,None)).toList)
  val kafka_0_8_2_2_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_8_2_2).map(n => TConfig(n,None)).toList)
  val kafka_0_9_0_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_9_0_0).map(n => TConfig(n,None)).toList)
  val kafka_0_9_0_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_9_0_1).map(n => TConfig(n,None)).toList)
  val kafka_0_10_0_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_10_0_0).map(n => TConfig(n,None)).toList)
  val kafka_0_10_0_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_10_0_1).map(n => TConfig(n,None)).toList)
  val kafka_0_10_1_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_10_1_0).map(n => TConfig(n,None)).toList)
  val kafka_0_10_1_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_10_1_1).map(n => TConfig(n,None)).toList)
  val kafka_0_10_2_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_10_2_0).map(n => TConfig(n,None)).toList)
  val kafka_0_10_2_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_10_2_1).map(n => TConfig(n,None)).toList)
  val kafka_0_11_0_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_11_0_0).map(n => TConfig(n,None)).toList)
  val kafka_0_11_0_2_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_0_11_0_2).map(n => TConfig(n,None)).toList)
  val kafka_1_0_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_1_0_0).map(n => TConfig(n,None)).toList)
  val kafka_1_0_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_1_0_1).map(n => TConfig(n,None)).toList)
  val kafka_1_1_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_1_1_0).map(n => TConfig(n,None)).toList)
  val kafka_1_1_1_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_1_1_1).map(n => TConfig(n,None)).toList)
  val kafka_2_0_0_Default = CreateTopic("",3,3,TopicConfigs.configNames(Kafka_2_0_0).map(n => TConfig(n,None)).toList)
